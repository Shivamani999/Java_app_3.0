...
pipeline{
    ...
    parameters{
        ...
        string(name: 'DockerHubUser', description: "name of the Application", defaultValue: 'shivamani99')
    }
        ...
        stage('Push Artifact to JFrog') {
         when { expression {  params.action == 'create' } }
            steps {
                script {
                    // Set variables
                    def ARTIFACTORY_URL = "http://192.168.0.108:8082/ui/repos/tree/General"
